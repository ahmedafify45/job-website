...
const JobListing = () => {
  ...
  const [selectedCategroies, setSelectedCategroies] = useState([])
  ...
  useEffect(() => {
    const matchesCategory = (job) =>
      selectedCategroies.length === 0 ||
      selectedCategroies.includes(job.category)
    ...
    setCurrentPage(1)
  }, [jobs, selectedCategroies, selectedLocation, searchFilter])
  return (
    <div className="container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8">
      ...
      <div className="w-full lg:w-1/4 bg-white px-4">
            ...
            {JobCategories.map((category, index) => (
              <li className="flex gap-3 items-center" key={index}>
                <input
                  ...
                  checked={selectedCategroies.includes(category)}
                />
                {category}
              </li>
            ))}
        ...
        {/* Location Filter */}
        <div className={showFilter ? "" : "max-lg:hidden mt-16"}>
